function Page404() {
	return (
	  <>
		<div
		  className="flex items-center h-full justify-center bg-indigo-500 bg-fixed bg-cover bg-bottom error-bg"
		  style={{
			backgroundImage:
			...
			<div className="row">
			  <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
				<div className="relative">
				  ...
				  style={{letterSpacing: '-0.75rem' , textShadow: '-8px 0 0 rgb(102 123 242)'}}>
					<span>4</span>
					<span>0</span>
					<span>4</span>
				  </h1>
